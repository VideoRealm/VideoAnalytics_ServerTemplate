...
- быстрота в структуру Flask
- широкий набор схожих проектов на Python для форсированного освоения актуальных технологий;
- высокая производительность 
- практичность и гибкость конфигурирования БД в PostgreSQL.
